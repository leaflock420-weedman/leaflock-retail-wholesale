...
const RETAIL_ENV = {
  ...
  BANK_ACCOUNT_NAME: envJson.BANK_ACCOUNT_NAME || "LeafLock & Co Pty Ltd",
  BANK_BSB: envJson.BANK_BSB || "",
  BANK_ACCOUNT_NUMBER: envJson.BANK_ACCOUNT_NUMBER || "",
  BANK_NAME: envJson.BANK_NAME || "",
