...
async function notifyRetailStockistApproved({ app, setupToken, setupCode }) {
  const portalUrl = process.env.SITE_URL || "https://www.wholesale.leaflock.com.au";
  ...
  return sendMail({
    ...
    html,
    text: `Approved for ${app.businessName}. Set password: ${setupUrl}.${setupCode ? ` Setup code: ${setupCode}.` : ""} Login: ${app.email} at ${portalUrl}/portal.html Forgot: ${forgotUrl}`,
  });
}
