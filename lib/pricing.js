...
function calculateGummyOrder(items) {
  ...
  if (mixedCartons > 0) notes.push("Mixed carton gummy rate applied.");
  if (!notes.length) {
    notes.push(subtotal > 0 ? "Gummy mix wholesale pricing applied." : "Add gummy mix to calculate pricing.");
  }
  ...
  return [
    {
      ...
      applies: "Retail stores: from $1.60 ea. Drops to $1.45 ea automatically at 500+ singles (pharmacy bulk is priced separately).",
    },
    {
