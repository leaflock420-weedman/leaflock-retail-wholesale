...
const PRICING = {
  ...
  gummy: {
    individual: { wholesale: 16, srp: 29.99 },
    bulk: { wholesalePerUnit: 14.5, minUnits: 6 },
...
function calculateGummyOrder(items) {
  ...
  else if (gummyIndividual >= gummy.bulk.minUnits) notes.push("Bulk rate ($14.50/unit) applied on 6+ pouches.");
  if (!notes.length) {
