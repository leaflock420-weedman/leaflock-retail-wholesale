 ...
 */
const { loadCatalogFromCsv } = require("./catalog-csv");
...
const EMBEDDED_CATALOG = [
  ...
  },
  {
    ...
    label: "Gummy mix 90g",
    items: [
      { sku: "GUM-90-STR", name: "Strawberry 90g Gummy Mix", wholesale: 16, rrp: 29.99 },
      { sku: "GUM-90-GRA", name: "Grape 90g Gummy Mix", wholesale: 16, rrp: 29.99 },
      { sku: "GUM-90-BLU", name: "Blue Raspberry 90g Gummy Mix", wholesale: 16, rrp: 29.99 },
      { sku: "GUM-90-DIY", name: "Create Your Own Flavour 90g Gummy Mix", wholesale: 16, rrp: 29.99 },
      {
        sku: "GUM-90-BUN",
...
const WHOLESALE_CATALOG = loadCatalogFromCsv() || EMBEDDED_CATALOG;
