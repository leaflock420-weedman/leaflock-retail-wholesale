    ...
    classes: [
      {
        ...
        publicNote: "Medicinal cannabis storage and related goods",
      },
      {
        class: 16,
        description: "Humidity control sheets of paper or plastic for foodstuff packaging",
        publicNote: "Humidity control packaging for retail store storage",
      },
    ],
    headline: "Registered Australian trade mark for medicinal cannabis storage and humidity control packaging",
  },
  productCerts: [
    "RoHS compliant",
    "REACH compliant",
