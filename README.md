...
Retail stockist wholesale portal for LeafLock humidity packs and DIY gummy mix — **separate from** [med.leaflock.com.au](https://med.leaflock.com.au) (med wholesale).
...
2. Create a **new** web service — do **not** connect to `leaflock-med-wholesale` or `med.leaflock.com.au`
...
- This repo must never deploy to the med Render service (`srv-d93nossvikkc73amkvv0`)
